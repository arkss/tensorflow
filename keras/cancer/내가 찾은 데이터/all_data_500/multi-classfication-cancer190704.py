...
for label in range(1,14):
    ...
    while len(sub_data) != 500:
        sub_data.loc[temp_new_index] = sub_data.loc[temp_copy_index] + 0.1
        temp_new_index += 1
        temp_copy_index += 1
...
plt.savefig("../graph_images/acc/acc_label13_alldata500.png")
...
plt.savefig("../graph_images/loss/loss_label13_alldata500.png")
