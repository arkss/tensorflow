...
""" 데이터 불러오기 """
all_data = pd.read_csv("./stomach_cancer.csv" )
...
for label in range(1,3):
    ...
    all_data_1000 = pd.concat([all_data_1000, sub_data], ignore_index=True)

print(all_data_1000)
    
from sklearn.utils import shuffle
all_data_1000 = shuffle(all_data_1000)
...
history = model.fit(train_data, one_hot_train_labels, validation_split=0.2,shuffle=True, epochs=500)
...
plt.savefig("./acc_binary_stomach.png")
...
plt.savefig("./loss_binary_stomach.png")
